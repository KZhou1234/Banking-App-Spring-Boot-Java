...
public class BankStatement {
    ...
    private static final String FILE = "/Users/kezhou/Documents/banking/java-banking-app/Statements/MyStatement.pdf";
    private UserRepository userRepository;
    private EmailService emailService;


    //-----------------Generate a list of transactions in a date range for a given account number----------
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("App Provider Bank"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.MAGENTA);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("1234, Street, City"));
